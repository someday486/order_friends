...
export type BusinessOrder = {
  ...
  orderedAt: string;
  deliveryDate: string;
  status: '작성중' | '승인대기' | '출고준비' | '부분출고' | '정산대기';
  paymentStatus: '예치금 차감' | '후불 예정' | '입금 확인';
};
...
export const businessOrders: BusinessOrder[] = [
  {
    ...
    status: '출고준비',
    paymentStatus: '예치금 차감',
  },
  {
    id: 'PO-240331-102',
    merchant: '송도 센트럴',
    supplier: '제주굿소싱',
    itemSummary: '제주 햇당근 10박스',
    qty: 10,
    amount: 154000,
...
export const businessSuppliers: BusinessSupplier[] = [
  {
    id: 'sup-1',
    name: '미남과일',
    categories: ['국내과일', '수입과일'],
    leadTime: 'D+1',
    cutoffLabel: '오전 10:30',
    minimumAmount: '150,000원',
    paymentTerms: '예치금 우선 차감',
