...
export declare class PublicOrderController {
    ...
    getBranchLegacy(branchId: string): Promise<import("./dto/public-order.dto").PublicBranchResponse>;
    ...
    getProductsLegacy(branchId: string): Promise<import("./dto/public-order.dto").PublicProductResponse[]>;
