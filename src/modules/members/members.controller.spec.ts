...
describe('MembersController', () => {
  ...
  it.each([
    ...
    },
    {
      name: 'addBrandMember',
      call: () =>
        controller.addBrandMember(makeReq(), 'brand-1', {
          userId: 'user-1',
          role: 'OWNER',
        } as any),
    ...
    },
    {
      ...
      call: () =>
        controller.updateBrandMember(makeReq(), 'brand-1', 'user-1', {
          role: 'ADMIN',
        } as any),
    ...
    },
    {
      ...
      call: () =>
        controller.addBranchMember(makeReq(), {
          branchId: 'branch-1',
          userId: 'user-2',
          role: 'STAFF',
        } as any),
      ...
      args: [
        'token',
        { branchId: 'branch-1', userId: 'user-2', role: 'STAFF' },
        false,
      ],
    },
    {
      ...
      call: () =>
        controller.updateBranchMember(makeReq(), 'branch-1', 'user-2', {
          role: 'VIEWER',
        } as any),
    ...
    },
    {
      ...
      call: () =>
        controller.removeBranchMember(makeReq(), 'branch-1', 'user-2'),
