...
-- - Orders and payments
-- ============================================================================
-- PREREQUISITE: Create test users in Supabase Dashboard first!
-- See supabase/setup_test_users.sql for full instructions.
-- ============================================================================

DO $$
DECLARE
  -- User IDs (replace with actual UUIDs from auth.users)
...
BEGIN
  ...
  -- ============================================================================
  -- Create Products (uses base_price, not price)
  -- ============================================================================
  ...
  -- Test Customer A: CREATED -> COMPLETED (full path)
  ...
  -- Test Customer B: CREATED -> COMPLETED (full path)
  ...
  -- Test Customer E: CREATED -> PREPARING
  ...
  -- Test Customer F: CREATED -> COMPLETED (full path)
  ...
  -- Test Customer I: CREATED -> COMPLETED (full path)
  ...
  -- Test Customer K: CREATED -> COMPLETED (full path)
